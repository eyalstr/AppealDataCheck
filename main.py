...
def main():
    #load_configuration()
    #DOC_TO_TEST = os.getenv("DOC_TO_TEST", "false").strip().lower() == "true"
    #log_and_print(f"DOC_TO_TEST={DOC_TO_TEST}")
    
    # case_ids = [ 2005393, 2005459, 2005042, 2005055, 2005058, 2005006, 2005078, 2005119, 2005224, 2005050,
